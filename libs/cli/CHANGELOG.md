...
## [0.0.42](https://github.com/notoookay/deepagents/compare/deepagents-cli==0.0.41...deepagents-cli==0.0.42) (2026-04-25)
...
* **cli:** `--max-turns` flag on non-interactive mode ([#2832](https://github.com/notoookay/deepagents/issues/2832)) ([567bcd8](https://github.com/notoookay/deepagents/commit/567bcd8f2065e089f4905a901efe7154add23121))
...
* **cli:** `--startup-cmd` flag ([#2841](https://github.com/notoookay/deepagents/issues/2841)) ([8adcc2c](https://github.com/notoookay/deepagents/commit/8adcc2c2e612346c263d02d1ec5c33e0d63da5a3))
* **cli:** `/agents` switcher ([#2558](https://github.com/notoookay/deepagents/issues/2558)) ([3a2b777](https://github.com/notoookay/deepagents/commit/3a2b77773a19dd48f9c51dfb35cdfc5c33126d77))
...
* **cli:** `shift+enter` newline on kitty-capable terminals ([#2869](https://github.com/notoookay/deepagents/issues/2869)) ([34e6614](https://github.com/notoookay/deepagents/commit/34e6614a2c6e6a7e33f763ac5b527c13b324a690))
* **cli:** actionable notifications, update modal ([#2855](https://github.com/notoookay/deepagents/issues/2855)) ([5fcd368](https://github.com/notoookay/deepagents/commit/5fcd368088079a84f151e0a3f5e4b9ac29c360c1))
...
* **cli:** custom auth via `[auth]` ([#2734](https://github.com/notoookay/deepagents/issues/2734)) ([417ddaa](https://github.com/notoookay/deepagents/commit/417ddaab4804a54a8f83721bb8577d65cfa3659f))
...
* **cli:** hint `Enter` behavior in `/model` empty state ([#2933](https://github.com/notoookay/deepagents/issues/2933)) ([7cffa16](https://github.com/notoookay/deepagents/commit/7cffa16a072bc77def78e4cda09c2e5a2cf8ca39))
...
* **cli:** refresh footer git branch after shell commands ([#2851](https://github.com/notoookay/deepagents/issues/2851)) ([ee4fddd](https://github.com/notoookay/deepagents/commit/ee4fddde9454ee8f7ede98ee9a346da6c5ccd3d9))
...
* **cli:** rework `/version`, add release-age and editable-install guard ([#2854](https://github.com/notoookay/deepagents/issues/2854)) ([1ae053f](https://github.com/notoookay/deepagents/commit/1ae053f347679e58562d2b81eb6d6e6e9bbf0b07))
...
* **cli:** subagents for `deepagents deploy` ([#2786](https://github.com/notoookay/deepagents/issues/2786)) ([7dd5565](https://github.com/notoookay/deepagents/commit/7dd5565e30ab91a2cd2ca10fcd227e590451f13c))
...
* **cli:** gate agent-swap resume hint on server checkpoint ([#2862](https://github.com/notoookay/deepagents/issues/2862)) ([f14b9cd](https://github.com/notoookay/deepagents/commit/f14b9cd3cc41f92ddb089d4294cba8496d517807))
...
* **cli:** keep thinking spinner visible during text streaming ([#2849](https://github.com/notoookay/deepagents/issues/2849)) ([2cb2244](https://github.com/notoookay/deepagents/commit/2cb22446bc1351d20e8bbfa9f23b5d668947351f))
...
* **cli:** normalize serialized message dicts in `/offload` ([#2808](https://github.com/notoookay/deepagents/issues/2808)) ([0d11bd4](https://github.com/notoookay/deepagents/commit/0d11bd46fd682c7aa3f008918771e9759dca7352))
...
* **cli:** queue `/model` switches during server startup ([#2895](https://github.com/notoookay/deepagents/issues/2895)) ([6ed7b65](https://github.com/notoookay/deepagents/commit/6ed7b65a40ac5bd926e94edd944bd552e8d6b5b4))
* **cli:** re-show thinking spinner on hitl/`ask_user` resume ([#2847](https://github.com/notoookay/deepagents/issues/2847)) ([34a6167](https://github.com/notoookay/deepagents/commit/34a6167b0c275c7e4da067ef276a837f60da2f8a))
...
* **cli:** restore ctrl+j newline keybinding ([#2827](https://github.com/notoookay/deepagents/issues/2827)) ([2e1a3f4](https://github.com/notoookay/deepagents/commit/2e1a3f45a9ff56390e294ea5b0f6a837200874ec))
